...
<html>
    ...
    background-size: cover;">
         <%@ include file="../hf/patientRegisterheader.jsp"%>
            ...
            <div class="card" style="background: transparent">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 text-center mb-5">
                            <h2 class="heading-section"> Patient Registration </h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-7">
                            <div class="login-wrap p-0">
                                ...
                                <form action="../patient/valPatientRegister.jsp" method="post" class="signin-form ">
                                    ...
                                    <div class="form-group">
                                        <input type="text" maxlength="20"  class="form-control" placeholder="Enter Last Name" required=""
                                                   name="lastName" >
                                    </div>
                                   
                                    <div class="form-group">
                                        <input type="text" maxlength="15"  class="form-control" placeholder="Enter NIC No"
                                                   name="NIC" >
                                    </div>
